;(function ($) {
    ...
    $.HSCore.components.HSUnfold = {
        _baseConfig: {
        ...
        }, _pageCollection: $(), init: function (collection, config) {
            var self;
            ...
            var self = this, $unfold = $($invoker.data('unfold-target'));
            if (eventType === 'hover' && !_isTouch()) {
                $invoker.on('mouseenter.HSUnfold', function () {
                    var $invoker = $(this), HSUnfold = $invoker.data('HSUnfold');
                    if (!HSUnfold) return;
                ...
                if (Boolean($invoker.data('unfold-target-is-menu'))) {
                    var $target = $($invoker.data('unfold-target')), $targetItems = $target.children();
    ...
    function AbstractUnfold(element, config) {
        ...
        this.smartPosition = function (target) {
            ...
            var $w = $(window), styles = getComputedStyle(target.get(0)),
    ...
    UnfoldCSSAnimation.prototype.show = function () {
        var self = this, activeEls = $(self)[0].config.unfoldTarget;
        $('[data-unfold-target="' + activeEls + '"]').addClass('active');
