                ...
                <div className="col-md-3 d-block">
                    <div className="left-side">
                        <div className="stardust-dropdown">
                            <Link className="sidebar-item" to={"/user/account"}>
                                <div className="sidebar-item-icon">
                                    <i className="fa-solid fa-user"></i>
                                </div>
                                <div style={{lineHeight: "1rem"}}><span className="item-name" style={{fontWeight: 500}}>Thông tin tài khoản</span>
                                </div>
                            </Link>
                        </div>
                    </div>
                    <div className="left-side">
                        <div className="stardust-dropdown">
                            <Link className="sidebar-item" to={"/user/address"}>
                                <div className="sidebar-item-icon">
                                    <i className="fa-solid fa-location-dot"/>
                                </div>
                                <div style={{lineHeight: "1rem"}}><span className="item-name" style={{fontWeight: 500}}>Sổ địa chỉ</span>
                                </div>
                            </Link>
                        </div>
                    </div>
                    <div className="left-side">
                        <div className="stardust-dropdown">
                            <Link className="sidebar-item" to={"/user/order"}>
                                <div className="sidebar-item-icon">
